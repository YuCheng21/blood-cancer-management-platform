        ...
        <div class="card border hv-shadow mb-4">
            ...
            <div class="card-body px-5 py-4">
                <div class="d-flex py-4">
                    <div class="input-group w-auto flex-grow-1 me-1">
                    ...
                    <button class="btn btn-secondary text-white w-auto mx-1" data-bs-toggle="modal" data-bs-target="#applyTaskModal">
                        套用
                    </button>
                    <button class="btn btn-secondary text-white w-auto mx-1" data-bs-toggle="modal" data-bs-target="#applyAllTaskModal">
                        全體套用
                    </button>
                </div>
